      ...
      <div className="flex flex-col gap-7 px-6 py-5 rounded-[10px] border border-custom-border-300 bg-custom-background-90">
        <div className="flex items-center justify-between gap-x-8 gap-y-2">
          <div className="flex flex-col gap-2.5">
            <h4 className="text-lg font-semibold">Auto-archive closed resolutions</h4>
            <p className="text-sm text-custom-text-200">
              MunicipaPro will automatically archive resolutions that have been completed or cancelled for the
        ...
        {projectDetails?.archive_in !== 0 && (
          <div className="flex items-center justify-between gap-2 w-full">
            <div className="w-1/2 text-base font-medium">
              Auto-archive resolutions that are closed for
            </div>
            <div className="w-1/2">
              <CustomSelect
