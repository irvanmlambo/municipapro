...
export type TTourSteps = "welcome" | "resolutions" | "cycles" | "modules" | "views" | "pages";
...
const TOUR_STEPS: {
  ...
  {
    key: "resolutions",
    title: "Plan with resolutions",
    description:
      "The resolution is the building block of the MunicipaPro. Most concepts in MunicipaPro are either associated with resolutions and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
    ...
    description:
      "Cycles help you and your team to progress faster, similar to the sprints commonly used in agile environment.",
    image: CyclesTour,
    prevStep: "resolutions",
    nextStep: "modules",
  },
  {
    key: "modules",
    ...
    description:
      "Modules break your big thing into Projects, to help you organize better.",
    image: ModulesTour,
    prevStep: "cycles",
    nextStep: "views",
  },
  {
    ...
    title: "Views",
    description:
      "Create custom filters to display only the resolutions that matter to you. Save and share your filters in just a few clicks.",
    image: ViewsTour,
    prevStep: "modules",
    nextStep: "pages",
  },
  {
    ...
    description: "Use Pages to quickly jot down resolutions when you're in a meeting or starting a day.",
    image: PagesTour,
    prevStep: "views",
  },
];
...
export const TourRoot: React.FC<Props> = ({ onComplete }) => {
  ...
  return (
    <>
      {step === "welcome" ? (
        <div className="w-4/5 md:w-1/2 lg:w-2/5 bg-custom-background-100 rounded-[10px] overflow-hidden">
          <div className="h-full overflow-hidden">
            ...
            <div className="h-2/5 overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-xl">
                Welcome to MunicipaPro, {user?.first_name} {user?.last_name}
              </h3>
              ...
              <div className="flex items-center gap-6 mt-8">
                <PrimaryButton onClick={() => setStep("resolutions")}>Take a Product Tour</PrimaryButton>
                <button
                  type="button"
        ...
        <div className="relative w-4/5 md:w-1/2 lg:w-3/5 bg-custom-background-100 rounded-[10px] grid grid-cols-10 overflow-hidden">
          <button
            type="button"
          ...
          <div className="col-span-10 lg:col-span-7  overflow-hidden">
            {/* <div
              ...
              <div className="h-full flex items-end justify-between gap-4 mt-3">
                <div className="flex items-center gap-4">
                  ...
                  {currentStep?.nextStep && (
                    <PrimaryButton onClick={() => setStep(currentStep.nextStep ?? "resolutions")}>
                      Next
                    </PrimaryButton>
                  )}
                </div>
