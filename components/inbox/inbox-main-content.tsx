          ...
          <div className="my-5 flex flex-col items-center gap-4">
            ...
            {inboxIssues && inboxIssues.length > 0 ? (
              <span className="text-custom-text-200">
                {inboxIssues?.length} resolutions found. Select an resolution from the sidebar to view its
                details.
              </span>
            ) : (
              <span className="text-custom-text-200">
                No resolutions found. Use{" "}
            ...
            >
              {issueStatus === -2 ? (
                <>
                  ...
                  <p>This resolution is still pending.</p>
                </>
              ) : issueStatus === -1 ? (
                <>
                  <XCircleIcon className="h-5 w-5" />
                  <p>This resolution has been declined.</p>
                </>
              ) : issueStatus === 0 ? (
                <>
                  ...
                  {new Date(issueDetails.issue_inbox[0].snoozed_till ?? "") < new Date() ? (
                    <p>
                      This resolution was snoozed till{" "}
                    ...
                    <p>
                      This resolution has been snoozed till{" "}
                      {renderShortDateWithYearFormat(
                        issueDetails.issue_inbox[0].snoozed_till ?? ""
                      )}
                      .
                ...
                <>
                  ...
                  <p>This resolution has been accepted.</p>
                </>
              ) : issueStatus === 2 ? (
                <>
                  <DocumentDuplicateIcon className="h-5 w-5" />
                  <p className="flex items-center gap-1">
                    This resolution has been marked as a duplicate of
                    <a
