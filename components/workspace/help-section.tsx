...
export const WorkspaceHelpSection: React.FC<WorkspaceHelpSectionProps> = ({ setSidebarActive }) => {
  ...
  return (
    <>
      ...
      >
        {!sidebarCollapse && (
          <div className="w-1/2 text-center cursor-default rounded-md px-2.5 py-1.5 font-medium outline-none text-sm bg-green-500/10 text-green-500" style={{visibility: 'hidden' }}>
