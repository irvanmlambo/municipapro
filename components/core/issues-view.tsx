        ...
        <StrictModeDroppable droppableId="trashBox">
          {(provided, snapshot) => (
            ...
            >
              ...
              Drop here to delete the resolution.
            </div>
          )}
        </StrictModeDroppable>
        {groupedByIssues ? (
          !isEmpty || issueView === "kanban" || issueView === "calendar" ? (
            ...
            <EmptyState
              title="Archived Resolutions will be shown here"
              description="All the resolutions that have been in the completed or canceled groups for the configured period of time can be viewed here."
            ...
            <EmptyState
              title={
                cycleId
                  ? "Cycle resolutions will appear here"
                  : moduleId
                  ? "Module resolutions will appear here"
                  : "Project resolutions will appear here"
              }
              description="Resolutions help you track individual pieces of work. With Resolutions, keep track of what's going on, who is working on it, and what's done."
              image={emptyIssue}
              buttonText="New Resolution"
