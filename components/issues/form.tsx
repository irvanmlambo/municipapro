  ...
  const handleAutoGenerateDescription = async () => {
    ...
    aiService
      .createGptTask(
        ...
        {
          prompt: issueName,
          task: "Generate a proper description for this resolution.",
        },
        user
      )
      .then((res) => {
        if (res.response === "")
          setToastAlert({
            ...
            title: "Error!",
            message:
              "Resolution title isn't informative enough to generate the description. Please try with a different title.",
          });
        ...
        <div className="space-y-5">
          <div className="flex items-center gap-x-2">
            ...
            <h3 className="text-xl font-semibold leading-6 text-custom-text-100">
              {status ? "Update" : "Create"} Resolution
            </h3>
          </div>
          {watch("parent") &&
            watch("parent") !== "" &&
