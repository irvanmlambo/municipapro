...
const MyIssuesPage: NextPage = () => {
  ...
  return (
    <WorkspaceAuthorizationLayout
      breadcrumbs={
        <Breadcrumbs>
          <BreadcrumbItem title="My Resolutions" />
        </Breadcrumbs>
      }
      right={
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          {Object.keys(properties).map((key) => {
                            ...
                            return (
                              ...
                              >
                                {key === "key" ? "ID" : replaceUnderscoreIfSnakeCase(key).trim() != "sub issue count" ? replaceUnderscoreIfSnakeCase(key): "sub resoultion count"}
                              </button>
                            );
                          })}
                        </div>
            ...
            {myIssues.length > 0 ? (
                    ...
                    <div className="flex items-center px-4 py-2.5 bg-custom-background-90">
                      <Disclosure.Button>
                        <div className="flex items-center gap-x-2">
                          <h2 className="font-medium leading-5">My Resolutions</h2>
              ...
              <EmptyState
                title={
                  projects
                    ? projects.length > 0
                      ? "You don't have any resolution assigned to you yet"
                      : "Resolutions assigned to you will appear here"
                    : ""
                }
                description={
                  projects
                    ? projects.length > 0
                      ...
                      : "Let's create your first project and add resolutions that you want to accomplish."
                    : ""
                }
                image={emptyMyIssues}
                buttonText={projects ? (projects.length > 0 ? "New Resolution" : "New Project") : ""}
